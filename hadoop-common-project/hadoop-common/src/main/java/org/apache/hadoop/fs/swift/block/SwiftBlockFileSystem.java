...
public class SwiftBlockFileSystem extends FileSystem {
   ...
   * @throws IOException
   */
  public SwiftBlockFileSystem(URI uri, Configuration configuration, SwiftBlockFileSystemStore store)
          throws IOException {
  ...
  /**
   * class initialization. Use this method to initialize class
